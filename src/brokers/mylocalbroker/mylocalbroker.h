#ifndef SRC_BROKERS_MYLOCALBROKER_MYLOCALBROKER_H_
#define SRC_BROKERS_MYLOCALBROKER_MYLOCALBROKER_H_
...
class MyLocalBrokerIFC : public AbstractBrokerAPI
{
public:
	MyLocalBrokerIFC(const std::string &cfg_file);
	...
	virtual uint64_t downloadMinuteData(const std::string_view &asset, const std::string_view &currency,
										const std::string_view &hint_pair, uint64_t time_from, uint64_t time_to, IHistoryDataSource::HistData &data) override;
...
#endif /* SRC_BROKERS_MYLOCALBROKER_MYLOCALBROKER_H_ */
